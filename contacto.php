<div class="contenedor-contacto">
    ...
    <div class="contenedor-mapa-form">
    	<div class="formulario">
    		...
    		<input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="ejemple@correo.com">
    		<label for="Teléfono">Teléfono</label>
    		<input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="987654321">
    	...
    	<div class="map">
            <div class="pestanas-mapas">
              ...
              <ul class="nav  nav-justified"" role="tablist">
                ...
                <li role="presentation" class="linea1"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/metro.png" alt="">Ruta desde Línea 1</a></li>
                <li role="presentation" class="linea5"><a href="#messages" aria-controls="messages" role="tab" data-toggle="tab"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/metro.png" alt="">Ruta desde Línea 5</a></li>
                <li role="presentation" class="linea6"><a href="#settings" aria-controls="settings" role="tab" data-toggle="tab"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/metro.png" alt="">Ruta desde Línea 6</a></li>
              </ul>
